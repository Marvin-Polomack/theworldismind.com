  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        onKeyDown={onKeyDown}
        className={cn(
          "z-10 w-full px-4 grow resize-none rounded-xl border border-input p-3 pr-24 text-sm ring-offset-background transition-[border] placeholder:text-muted-foreground focus-visible:border-primary focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
          showFileList && "pb-16",
          className
        )}
      ...
      <div className="absolute right-3 top-3 z-20 flex gap-2 px-4">
        {props.allowAttachments && (
          <Button
            type="button"
            size="icon"
