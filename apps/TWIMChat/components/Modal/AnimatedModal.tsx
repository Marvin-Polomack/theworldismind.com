          ...
          <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center">
              <ModalBody className="pointer-events-auto">
                <ModalContent className="flex flex-col items-center justify-center min-h-[300px]">
                  ...
                  <p className="text-center text-neutral-600 dark:text-neutral-100 mb-11">
                  ...
                  <Input
                    ...
                    className="w-full bg-zinc-800 border-none focus:ring-0 placeholder-gray-400"
                  />
                </ModalContent>
